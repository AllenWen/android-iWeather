...
public interface Api {
    ...
    LiveData<ApiResponse<BaseWrapperEntity<WeatherNowEntity>>> now(@Query("key") String key, @Query("location") String location, @Query("language") String language, @Query("unit") String unit);

    /**
     * 城市搜索
     */
    @GET("location/search.json")
    LiveData<ApiResponse<BaseWrapperEntity<LocationEntity>>> searchCity(@Query("key") String key, @Query("q") String q, @Query("language") String language, @Query("limit") int limit, @Query("offset") int offset);
